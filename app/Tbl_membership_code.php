...
class Tbl_membership_code extends Model
{
	...
	protected $fillable = ['order_form_number','membership_code_upcoin','code_activation', 'generated_by','code_type_id','membership_id', 'product_package_id', 'admin_id', 'inventory_update_type_id', 'account_id','created_at','used','blocked'];
