...
class Globals
{
    ...
    public static function create_voucher_code($code)
    {
    ...
    public static function create_membership_code($code)
    {
    ...
    public static function create_membership_code_sale($code)
    {
