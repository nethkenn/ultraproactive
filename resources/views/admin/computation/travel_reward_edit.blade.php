...
@section('content')
    <div class="row header">
        <div class="title col-md-8">
            <h2><i class="fa fa-users"></i>  Edit Reward</h2>
        </div>
    ...
    <div class="col-md-12 form-group-container">
        <form id="country-add-form" method="post">
            ...
            <div class="form-group col-md-6">
                ...
                @endif
                <input name="travel_reward_name" value="{{$data->travel_reward_name}}" required="required" class="form-control" id="" placeholder="" type="text">
            </div>  
            <div class="form-group col-md-6">
                ...
                @endif
                <input name="required_points" value="{{$data->required_points}}" required="required" class="form-control" id="" placeholder="" type="text">
            </div>   
        </form>
    </div>
@endsection