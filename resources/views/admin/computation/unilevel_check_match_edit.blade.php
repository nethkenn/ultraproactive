...
@section('content')
    <div class="row header">
        <div class="title col-md-8">
            <h2><i class="fa fa-star-half-o"></i> UNILEVEL CHECK MATCH / Update</h2>
        </div>
        <div class="buttons col-md-4 text-right">
            <button onclick="location.href='admin/utilities/unilevel_check_match'" type="button" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</button>
    ...
    <div class="col-md-12 form-group-container">
        <form id="country-add-form" method="post">
            ...
            <div class="form-group col-md-12">
                ...
                <input name="check_match_level" value="{{ $data->check_match_level }}" required="required" class="form-control level-input" id="" placeholder="" type="text">
            </div>
