...
@section('content')
	<div class="header col-md-12" >
	    ...
	    <div class="buttons col-md-4 text-right">
	        <button onclick="location.href='admin/transaction/claims'" type="button" class="btn btn-default"><i class="fa fa-angle-double-left"></i> Back</button>
	    </div>
    </div>
...
@endsection
@section('script')
    <script type="text/javascript" src="resources/assets/admin/process_claim.js">
    </script>
@endsection