...
@section('content')
	<div class="header col-md-12" >
	    ...
	    <div class="buttons col-md-4 text-right">
	        ...
	        <!--<button onclick="$('#product-package-add-form').submit();" type="button" class="btn btn-primary save_btn"><i class="fa fa-save"></i> Save</button>-->
	        <button type="button" class="btn btn-primary save_btn"><i class="fa fa-save"></i> Save</button>
	    </div>
    </div>
