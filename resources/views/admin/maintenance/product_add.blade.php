...
@section('content')
	<div class="header col-md-12" >
	    <div class="title col-md-8">
	        <h2><i class="fa fa-tag"></i> Add New Product</h2>
	    </div>
	    <div class="buttons col-md-4 text-right">
	        ...
	        <button onclick="$('#product-add-form').submit();" type="button" class="btn btn-primary"><i class="fa fa-save"></i> Save</button>
	    </div>
    </div>
        ...
        <form id="product-add-form" method="post">
            <div class="form-group col-md-8">
                ...
                <div class="form-group col-md-12">
                    ...
                    <textarea name="product_info" value="{{Request::input('product_description')}}" required="required" class="form-control" id="" placeholder=""></textarea>
                </div>
                <div class="form-group col-md-12">
                ...
                <div class="form-group col-md-12">
                    ...
                    @else
                        <input id="prod_cat_input" name="product_category" value="{{Request::input('product_category')}}" required="required" class="form-control" id="" placeholder="Add new Product Category" type="text">
                    @endif
                </div>
