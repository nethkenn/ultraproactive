        ...
        <form id="country-add-form" class="form-horizontal" action="admin/maintenance/earn/edit_submit" method="post">
            <div class="form-group col-md-8">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="text" class="form-control" id="title" name="title" value="{{ $earn->earn_title }}" required>
                    </div>
                </div>
                <div class="form-group">
                    <label for="description" class="col-sm-2 control-label">Earn Description</label>
                    <div class="col-sm-10">
                        <textarea class="form-control" id="description" name="description">{{ $earn->earn_description }}</textarea>
                    </div>
                </div> 
            </div>
        </form>
