<form id="checkout-form" class="form-horizontal">
   <button data-remodal-action="close" class="remodal-close"></button>
    ...
    <button type="submit" class="checkawt button hidden" id="submit-checkout">Submit Checkout</button>
    <button type="submit" class="checkawt button hidden" id="submit-checkout-gc">Submit Checkout Using GC</button>
</form>
